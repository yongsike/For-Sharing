...
export const AIDisclaimerPill: React.FC<{
    ...
    /** Optional: show a Regenerate pill beside Provide Feedback (focused mode). */
    showRegenerate?: boolean;
    onRegenerate?: () => void;
    regenerateDisabled?: boolean;
}> = ({ mode, onAIModalOpen, onFeedbackModalOpen, showRegenerate, onRegenerate, regenerateDisabled }) => {
    if (mode === 'overview') {
        return (
            <div style={{
                display: 'flex',
                    ...
                    {showRegenerate && onRegenerate && (
                        <button
                            ...
                            style={{
                                ...
                                opacity: regenerateDisabled ? 0.65 : 1,
                                transition: 'all 0.2s ease',
                            }}
                            onMouseEnter={(e) => {
    ...
    return (
        <div style={{
            ...
            <AIDisclaimerButton
                ...
                style={{ marginLeft: showRegenerate && onRegenerate ? '0.5rem' : 'auto' }}
                icon={
                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
